...
const createTask = asyncHandler(async (req, res) => {
  try {
    ...
    const { title, team, stage, date, priority, assets, links, description, assignedTo, project, startDate, endDate, tag } = req.body;
...
const updateTask = asyncHandler(async (req, res) => {
  const { id } = req.params;
  const { title, date, team, stage, priority, assets, links, description, project, startDate, endDate } = req.body;
